...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
      ...
      for(unsigned i=0;i<N-1;++i){
        ...
        //set the constraints for inital state
        ...
        // setup the rest of model constraints
        for(unsigned t=1;t<N;++t){
            ...
            AD<double> accel=vars[a_start+t-1];
            // define the y position at x
            AD<double> f0=coeffs[0] + coeffs[1] * x0 + coeffs[2] * CppAD::pow(x0, 2) + coeffs[3] * CppAD::pow(x0, 3);
            AD<double> psi_des=CppAD::atan(coeffs[1]+2*coeffs[2]*x0+3*coeffs[3]*CppAD::pow(x0,2));
